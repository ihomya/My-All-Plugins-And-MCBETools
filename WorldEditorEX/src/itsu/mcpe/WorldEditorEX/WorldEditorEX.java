...
import gamesukimanirs.builderpermission.Main;
...
public class WorldEditorEX extends PluginBase {
    ...
    private Main builderPerm;

    @Override
    public void onEnable() {
    	getLogger().info(TextFormat.AQUA + "WorldEditorEX BuilderPermission Edition");
       ...
       if((builderPerm = (Main) getServer().getPluginManager().getPlugin("BuilderPermission")) == null) {
    	   getLogger().alert("このプラグインの動作にはBuilderPermissionプラグインが必要です。");
    	   getLogger().alert("プラグインを無効化します。");
    ...
    private void help(CommandSender sender) {
        ...
        bf.append(TextFormat.GREEN + "[WorldEditorEX] WorldEditorEX BuilderPermission Edition ヘルプ\n");
        ...
        bf.append(TextFormat.AQUA + "/builderset [id:meta] " + TextFormat.WHITE + "Builder権限のみ許可されます。指定した[id:meta]のブロックで指定した範囲を埋め尽くします。引数でブロックを指定しない場合は前回/setをした時のブロックが使われます。\n");
        ...
        bf.append(TextFormat.AQUA + "開発: " + TextFormat.WHITE + "Itsu(itsu020402)/"
                ...
                + TextFormat.LIGHT_PURPLE + "\nWorldEditorEX BuilderPermission Edition LICENSE: GPL-v3.0");
